...
INSERT INTO schemes (id, code, name, name_hi, name_mr, category, department, description, description_hi, description_mr, max_benefit, subsidy_pct, interest_rate, min_age, max_age, max_income, is_marginalized_entrepreneur, marginalized_focus, target_occupations, required_documents, application_process) VALUES
...
6000, 100.00, 0.00, 18, 75, 300000, FALSE, NULL,
...
1750000, 35.00, 8.50, 18, 60, 1200000, TRUE, 'SC, ST, OBC, Women, Minorities & Micro-Enterprises (Special 35% Subsidy)',
...
50000, 0.00, 8.00, 18, 65, 500000, TRUE, 'Micro Retailers, Home-based Artisans, Hawkers & Small Vendors',
'["Street Vendor", "Small Business", "Artisan / Weaver", "Self Employed", "Driver", "Farmer"]',
'["Identity & Address Proof (Aadhaar / Voter ID)", "Quotation of items to be purchased", "Passport size photos", "Current Business details proof"]',
...
500000, 0.00, 8.75, 18, 65, 800000, TRUE, 'Growing Micro-Enterprises, Self-Employed Artisans & Small Shops',
'["Small Business", "Entrepreneur", "Retailer", "Self Employed"]',
'["Last 6 months bank statement", "Proof of business registration/existence", "Sales tax/GST returns if applicable", "Machinery & Stock Quotation"]',
...
10000000, 15.00, 7.75, 18, 60, 2000000, TRUE, 'Scheduled Caste (SC), Scheduled Tribe (ST) & Women Greenfield Entrepreneurs',
'["Women", "Entrepreneur", "Small Business", "Graduate"]',
'["Identity Proof (Aadhaar & PAN Card)", "Caste Certificate (SC/ST) or Proof of 51%+ Woman Ownership", "Detailed Greenfield Project Report", "Bank Account Statement (Past 6 Months)", "Pollution Control / NOC (if applicable)"]',
...
250000, 50.00, 0.00, 18, 70, 500000, FALSE, NULL,
'["Farmer", "Cultivator"]',
...
50000, 7.00, 7.00, 18, 65, 300000, TRUE, 'Urban & Semi-urban Street Vendors, Hawkers & Daily Wage Micro-Vendors',
'["Street Vendor", "Daily Wage Earner", "Hawker"]',
'["Vending Certificate / Urban Local Body (ULB) Identity Card", "Aadhaar Card with linked Mobile Number", "Bank Passbook / Account Details", "Letter of Recommendation (LoR) from Town Vending Committee"]',
...
180000, 80.00, 0.00, 18, 72, 400000, FALSE, NULL,
'["Farmer", "Cultivator"]',
...
12000, 100.00, 0.00, 60, 100, 150000, FALSE, NULL,
...
140000, 20.00, 4.00, 18, 55, 300000, TRUE, 'Backward Classes, OBC, SC/ST, Minority Women Entrepreneurs & SHG Members',
'["Women", "Artisan / Weaver", "Small Business", "Self Employed"]',
'["Self Help Group (SHG) Membership Proof or Individual Unit Registration", "Aadhaar Card & PAN Card", "Caste / Backward Community Certificate", "Bank Account Passbook with IFSC", "Income Certificate from Tehsildar"]',
...
300000, 25.00, 7.50, 18, 35, 450000, TRUE, 'Certified Vocational Trainees, ITI Grads, Young Artisans & First-Generation Youth',
'["Student / Graduate", "Artisan / Weaver", "Self Employed", "Unemployed Youth"]',
'["Skill Certification / ITI Diploma / Vocational Certificate", "Project Quotation for tools & equipment", "Aadhaar Card & PAN Card", "Proof of Residence in Maharashtra"]',
